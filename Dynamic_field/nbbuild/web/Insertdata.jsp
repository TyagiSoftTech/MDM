   ...
   if(table_field1!=null && table_field1.size()!=0)
	{
	  ...
	  %>
	   ...
	   <%   for(int i=0; i<size;i++)
		...
		<form action="InsertDataServlet" id="bookForm" method="post" class="form-horizontal" >
	       ...
	       <tbody>	
				 ...
				 %>
			   <td>
				<input type="text" class="form-control" name="book" placeholder="Field" />
